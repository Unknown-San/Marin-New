...
from Raiden.events import register as Raiden
from Raiden import telethn as bot
        ...
        if not is_animated:
            try:
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                text="pack", url=f"t.me/addstickers/{packname}"
                            )
                        ]
                    ]
                ),
                ...
                if (
                    ...
                    msg.reply_text(
                        "Sticker successfully added to pack"
                        % packname
                        + "\n"
                        "Emoji is:" + " " + sticker_emoji,
                        reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text="pack", url=f"t.me/addstickers/%s"
                            )
                        ]
                    ]
                ),
...
def makepack_internal(
    ...
    try:
        ...
        if e.message == "Sticker set name is already occupied":
            msg.reply_text(
                "Your pack can be found here" % packname,
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
            ...
            msg.reply_text(
                "Sticker pack successfully created. Get it here"
                % packname,
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./Raiden/resources/Vampire Wars.otf"
