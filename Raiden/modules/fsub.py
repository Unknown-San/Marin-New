            ...
            if client.get_chat_member(chat_id, user_id).status not in (
                ...
                try:
                    ...
                    try:
                        ...
                        sent_message.edit(
                            "❗ **Voilet Evergarden is not an admin here..**\n__Give me ban permissions and retry.. \n#Ending FSub...__"
                        )
                    except RPCError:
                        return
...
@pgram.on_message(filters.command(["forcesubscribe", "forcesub", f"forcesub@Voilet_probot", f"forcesubscribe@Voilet_probot"]) & ~filters.private)
...
__help__ = """
*Force Subscribe*:
- Violet can mute members who are not subscribed your channel until they subscribe
