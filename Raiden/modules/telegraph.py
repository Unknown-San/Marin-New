...
nobara = "NOBARA"
telegraph = Telegraph()
r = telegraph.create_account(short_name=nobara)
auth_url = r["auth_url"]
    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "gm":
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await h.delete()
                await event.reply("Telegraph For [{}](tg://user?id={})[.](https://telegra.ph{})".format(event.sender.first_name, event.sender.id, media_urls[0]), link_preview=True, buttons=BUTTON)
        elif input_str == "xt":
