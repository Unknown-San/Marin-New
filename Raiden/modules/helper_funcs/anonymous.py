...
from Raiden import DEV_USERS, WHITELIST_USERS, dispatcher
from Raiden.modules.helper_funcs.decorators import raidencallback
    ...
    def wrapper(func):
        ...
        def awrapper(update: Update, context: CallbackContext, *args, **kwargs):
            ...
            if is_anon:
                ...
                if getattr(mem, permission.value) is True or mem.status == "creator" or user_id in WHITELIST_USERS:
                    return func(update, context, *args, **kwargs)
                else:
